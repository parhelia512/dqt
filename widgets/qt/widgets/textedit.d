...
/// Binding for C++ class [QTextEdit](https://doc.qt.io/qt-6/qtextedit.html).
...
/+pragma(inline, true) QFlags!(QTextEdit.AutoFormatting.enum_type) operator ^(QTextEdit.AutoFormatting.enum_type f1, QTextEdit.AutoFormatting.enum_type f2)nothrow{return QFlags!(QTextEdit.AutoFormatting.enum_type)(f1)^f2;}+/
/+pragma(inline, true) QFlags!(QTextEdit.AutoFormatting.enum_type) operator ^(QTextEdit.AutoFormatting.enum_type f1, QFlags!(QTextEdit.AutoFormatting.enum_type) f2)nothrow{return f2^f1;}+/
/+pragma(inline, true) void operator +(QTextEdit.AutoFormatting.enum_type f1, QTextEdit.AutoFormatting.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator +(QTextEdit.AutoFormatting.enum_type f1, QFlags!(QTextEdit.AutoFormatting.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator +(int f1, QFlags!(QTextEdit.AutoFormatting.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator -(QTextEdit.AutoFormatting.enum_type f1, QTextEdit.AutoFormatting.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator -(QTextEdit.AutoFormatting.enum_type f1, QFlags!(QTextEdit.AutoFormatting.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator -(int f1, QFlags!(QTextEdit.AutoFormatting.enum_type) f2)nothrow;+/
/+pragma(inline, true) void operator +(int f1, QTextEdit.AutoFormatting.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator +(QTextEdit.AutoFormatting.enum_type f1, int f2)nothrow;+/
/+pragma(inline, true) void operator -(int f1, QTextEdit.AutoFormatting.enum_type f2)nothrow;+/
/+pragma(inline, true) void operator -(QTextEdit.AutoFormatting.enum_type f1, int f2)nothrow;+/
static if (defined!"QT_TYPESAFE_FLAGS")
{
/+pragma(inline, true) QTextEdit.AutoFormatting operator ~(QTextEdit.AutoFormatting.enum_type e)nothrow{return~QTextEdit.AutoFormatting(e);}+/
/+pragma(inline, true) void operator |(QTextEdit.AutoFormatting.enum_type f1, int f2)nothrow;+/
}
static if (!defined!"QT_TYPESAFE_FLAGS")
{
