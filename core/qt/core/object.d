...
pragma(inline, true) T*
 qobject_iid_cast(T)(QObject object, const(char)* IId = qobject_interface_iid!(T*)())
{
    return reinterpret_cast!(T*)((object ? object.qt_metacast(IId) : null));
}
...
alias QInvokable = QObject.QInvokable;
